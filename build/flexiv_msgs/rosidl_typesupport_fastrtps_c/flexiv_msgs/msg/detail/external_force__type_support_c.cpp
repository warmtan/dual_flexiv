...
#include "flexiv_msgs/msg/detail/external_force__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // force, moment
...
using _ExternalForce__ros_msg_type = flexiv_msgs__msg__ExternalForce;
...
static uint32_t _ExternalForce__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flexiv_msgs__msg__ExternalForce(
...
{
  return max_serialized_size_flexiv_msgs__msg__ExternalForce(
    full_bounded, 0);
}
