...
bool flexiv_msgs__msg__cartesian_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flexiv_msgs.msg._cartesian_state.CartesianState", full_classname_dest, 47) == 0);
  }
  flexiv_msgs__msg__CartesianState * ros_message = _ros_message;
  {  // position
...
PyObject * flexiv_msgs__msg__cartesian_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("flexiv_msgs.msg._cartesian_state");
