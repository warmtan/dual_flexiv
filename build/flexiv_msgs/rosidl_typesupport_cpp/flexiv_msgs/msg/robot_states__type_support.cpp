...
static const _RobotStates_type_support_symbol_names_t _RobotStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexiv_msgs, msg, RobotStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, flexiv_msgs, msg, RobotStates)),
  }
};
...
{
  return &::flexiv_msgs::msg::rosidl_typesupport_cpp::RobotStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, flexiv_msgs, msg, RobotStates)() {
  return get_message_type_support_handle<flexiv_msgs::msg::RobotStates>();
}
