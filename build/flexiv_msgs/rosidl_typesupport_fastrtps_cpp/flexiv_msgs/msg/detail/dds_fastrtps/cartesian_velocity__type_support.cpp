...
#include "flexiv_msgs/msg/detail/cartesian_velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const flexiv_msgs::msg::CartesianVelocity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flexiv_msgs::msg::CartesianVelocity & ros_message)
{
  // Member: linear
...
{
  auto typed_message =
    static_cast<const flexiv_msgs::msg::CartesianVelocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flexiv_msgs::msg::CartesianVelocity *>(
    untyped_ros_message);
...
{
  return max_serialized_size_CartesianVelocity(full_bounded, 0);
}
...
{
  return &flexiv_msgs::msg::typesupport_fastrtps_cpp::_CartesianVelocity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexiv_msgs, msg, CartesianVelocity)() {
  return &flexiv_msgs::msg::typesupport_fastrtps_cpp::_CartesianVelocity__handle;
}
